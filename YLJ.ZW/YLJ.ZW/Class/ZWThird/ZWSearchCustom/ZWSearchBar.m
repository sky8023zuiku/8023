...
//    [txtField becomeFirstResponder];
    ...
    txtField.tintColor = [UIColor grayColor];
...
- (BOOL)textFieldShouldReturn:(UITextField *)textField
{
   if (![textField isExclusiveTouch]) {
    ...
    if (self.clickSearchCallback) {
        self.clickSearchCallback(textField.text);
    }
   return YES;
}

- (BOOL)textFieldShouldBeginEditing:(UITextField *)textField {
    if (self.txtfieldShouldBeginEditingCallback) {
        self.txtfieldShouldBeginEditingCallback(textField.text);
    }
...
//    [self.txtField setValue:colorPlaceholder forKeyPath:@"_placeholderLabel.textColor"];
    self.txtField.textColor = colorPlaceholder;
}
...
//    [self.txtField setValue:[UIFont boldSystemFontOfSize:cusFontPlaceHolder] forKeyPath:@"_placeholderLabel.font"];
    self.txtField.font = [UIFont boldSystemFontOfSize:cusFontPlaceHolder];
}
