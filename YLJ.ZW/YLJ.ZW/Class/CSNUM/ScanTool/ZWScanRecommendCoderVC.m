...
- (void)createUI {
    ...
    imageView.image =  [self generateQRCodeWithString:[self dictionaryToJson:QrCodeDic] Size:200];
    ...
    [centerImage sd_setImageWithURL:[NSURL URLWithString:[NSString stringWithFormat:@"%@%@",httpImageUrl,self.userInfo[@"headImages"]]] placeholderImage:[UIImage imageNamed:@""]];
    centerImage.layer.cornerRadius = 0.05*kScreenWidth;
    centerImage.layer.masksToBounds = YES;
    centerImage.center = imageView.center;
    [toolView addSubview:centerImage];
