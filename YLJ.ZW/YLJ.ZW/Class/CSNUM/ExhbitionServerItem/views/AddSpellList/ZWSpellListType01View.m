...
@interface ZWSpellListType01View()<UITableViewDelegate,UITableViewDataSource>
...
@implementation ZWSpellListType01View
...
- (void)createTableViewWithCell:(UITableViewCell *)cell withIndex:(NSInteger)index {
    ...
    if (index == 0) {
        ...
        titleLabel.text = @"布展时间：";
    }else if (index == 4) {
        titleLabel.text = @"展期：";
    }else if (index == 5) {
        titleLabel.text = @"展台面积：";
    }else if (index == 6) {
        titleLabel.text = @"展厅：";
    }else if (index == 7) {
        titleLabel.text = @"材质：";
    ...
    if (index == 0) {
        ...
        detailLabel.text = [NSString stringWithFormat:@"%@~%@",[self timeWithStr:self.model.decorateStartTime],[self timeWithStr:self.model.decorateEndTime]];
    }else if (index == 4) {
        detailLabel.text = [NSString stringWithFormat:@"%@~%@",[self timeWithStr:self.model.startTime],[self timeWithStr:self.model.endTime]];
    }else if (index == 5) {
        detailLabel.text = [self valueText:[NSString stringWithFormat:@"%@m²",self.model.size]];
    }else if (index == 6) {
        detailLabel.text = [self valueText:self.model.hallNumber];
    }else if (index == 7) {
        detailLabel.text = [self valueText:self.model.material];
    }else if (index == 8) {
        detailLabel.text = [self valueText:[NSString stringWithFormat:@"%@",self.model.exhibitorCount]];
    }else if (index == 9) {
