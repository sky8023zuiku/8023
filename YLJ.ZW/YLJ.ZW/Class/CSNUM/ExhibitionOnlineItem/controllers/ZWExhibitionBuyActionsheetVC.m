...
//                    ZWTopUpModel *model = [ZWTopUpModel parseJSON:myDic];
                ...
                [[YNavigationBar sharedInstance]createSkinNavigationBar:nav.navigationBar withBackColor:skinColor withTintColor:[UIColor whiteColor]];
    ...
    if (self.exhibitionId) {
        ...
        [[ZWDataAction sharedAction]postFormDataReqeustWithURL:zwExhibitionCreateOrder parametes:parametes successBlock:^(NSDictionary * _Nonnull data) {
            ...
            if (zw_issuccess) {
                ...
                ZWCreateOrderModel *model = [ZWCreateOrderModel mj_objectWithKeyValues:myDic];
