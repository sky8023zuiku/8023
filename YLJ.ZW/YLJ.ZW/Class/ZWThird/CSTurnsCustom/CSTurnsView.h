...
@protocol CSTurnsViewDataSource;
@protocol CSTurnsViewDelegate;
/******************************
...
******************************/
typedef enum{
    CSTurnsViewOrientationHorizontal = 0,
    CSTurnsViewOrientationVertical
}CSTurnsViewOrientation;


NS_ASSUME_NONNULL_BEGIN

@interface CSTurnsView : UIView<UIScrollViewDelegate>
/**
 *  默认为横向
 */
@property (nonatomic,assign) CSTurnsViewOrientation orientation;
...
@property (nonatomic,assign)   id <CSTurnsViewDataSource> dataSource;
@property (nonatomic,assign)   id <CSTurnsViewDelegate> delegate;
/**
 *  指示器
 */
...
@protocol  CSTurnsViewDelegate<NSObject>
 ...
 *  @param flowView   <#flowView description#>
 */
- (void)didScrollToPage:(NSInteger)pageNumber inFlowView:(CSTurnsView *)flowView;
/**
 *  点击了第几个cell
 *
 *  @param subView 点击的控件
...
@protocol CSTurnsViewDataSource <NSObject>
/**
 *  返回显示View的个数
 *
 *  @param flowView <#flowView description#>
