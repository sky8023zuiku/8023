...
@interface ZWExhibitorsDetailsVC ()<UITableViewDataSource,UITableViewDelegate,DCCycleScrollViewDelegate,UICollectionViewDelegate,UICollectionViewDataSource>
        ...
        [[ZWDataAction sharedAction]postFormDataReqeustWithURL:zwExhibitorsDetails parametes:@{@"merchantId":self.merchantId} successBlock:^(NSDictionary * _Nonnull data) {
            ...
            if (zw_issuccess) {
                ...
                for (NSDictionary *myDic in myIndustries) {
                    ZWExbihitorsIndustriesModel *model = [ZWExbihitorsIndustriesModel mj_objectWithKeyValues:myDic];
                ...
                ZWExhibitorsDetailModel *model = [ZWExhibitorsDetailModel mj_objectWithKeyValues:myData];
    ...
    if (self.merchantId) {
        ...
        [[ZWDataAction sharedAction]postFormDataReqeustWithURL:zwExhibitorsContactList parametes:@{@"merchantId":self.merchantId} successBlock:^(NSDictionary * _Nonnull data) {
            ...
            if (zw_issuccess) {
               ...
               NSMutableArray *myArray = [NSMutableArray array];
               for (NSDictionary *myDic in myData) {
                   ZWExhibitorsContactModel *model = [ZWExhibitorsContactModel mj_objectWithKeyValues:myDic];
                   [myArray addObject:model];
               }
...
- (void)browseBtnClick:(UIButton *)btn {
    ...
    NSString *urlTitle = [array objectAtIndex:0];
    [[ZWPdfManager shareManager]createPdfBreview:self withUrl:urlStr withFileName:urlTitle];
}
...
- (void)downloadBtnClick:(UIButton *)btn {
    ...
    NSString *urlStr = [NSString stringWithFormat:@"%@%@",httpImageUrl,[array objectAtIndex:1]];
    NSString *urlTitle = [array objectAtIndex:0];
    [[ZWPdfManager shareManager]downloadPdfProfile:self withUrl:urlStr withFileName:urlTitle];
}
