...
//    [self locationStart];
    ...
    CSSearchBarStyle *searchBar = [[CSSearchBarStyle alloc]initWithFrame:CGRectMake(0.04*kScreenWidth, 7, 0.92*kScreenWidth, 30)];
    ...
    searchView.backgroundColor = [UIColor colorWithRed:234/255.0 green:235/255.0 blue:237/255.0 alpha:1];
...
- (void)createNavigationBar {
    ...
    [[YNavigationBar sharedInstance]createLeftBarWithImage:[UIImage imageNamed:@"zai_dao_icon_left"] barItem:self.navigationItem target:self action:@selector(cancelButtonDown:)];
}
