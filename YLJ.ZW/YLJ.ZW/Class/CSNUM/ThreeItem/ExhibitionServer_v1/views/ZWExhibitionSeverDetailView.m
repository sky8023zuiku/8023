...
- (void)takeOneFrame:(CGRect)frame imagesArray:(NSArray<ZWExhibitionServerDetailCaseModel *> *)images {
    ...
    [_imageView sd_setImageWithURL:[NSURL URLWithString:[self isChinese:images[0].caseUrl]] placeholderImage:[UIImage imageNamed:@"tm_placeholder_images"]];
    _imageView.tag = 0;
...
- (void)takeTwoFrame:(CGRect)frame imagesArray:(NSArray<ZWExhibitionServerDetailCaseModel *> *)images {
    ...
    for (int i = 0; i<images.count; i++) {
        ...
        [_imageView sd_setImageWithURL:[NSURL URLWithString:[self isChinese:images[i].caseUrl]] placeholderImage:[UIImage imageNamed:@"tm_placeholder_images"]];
        _imageView.tag = i;
        _imageView.clipsToBounds = YES;
        _imageView.userInteractionEnabled = YES;
        _imageView.contentMode = UIViewContentModeScaleAspectFill;
